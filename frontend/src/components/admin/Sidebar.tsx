...
export default function Sidebar({ user, className }: { user: AdminUser; className?: string }) {
  ...
  const items: NavItem[] = useMemo(
    () => [
      ...
      { href: '/admin/stock-transfers', label: 'تحويلات المخزون', icon: ArrowRightLeft, permission: 'inventory.view' },
      ...
      { href: '/admin/backups', label: 'النسخ الاحتياطي', icon: Database, permission: 'settings.manage' },
